...
<div id="secoes" class="w3-container person">
 ...
 <div class="w3-container w3-blue">
  ...
  <form class="w3-container" name="" method="POST" action="http://tcc2017.com.br/renato/tsis/secao/update/<?php echo $_SESSION["id_secao"];?>">
  <p>
  <label>Editar Seção</label>
  <input class="w3-input" name="txtNomeSecao" value="<?php echo $_SESSION["nomeSecao"];?>" type="text"></p>
