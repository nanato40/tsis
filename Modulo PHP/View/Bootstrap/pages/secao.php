                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                        	...
                        	<form name="" method="POST" action="http://tcc2017.com.br/renato/tsis/secao/salvarSecao">
				                            <div class="form-group">
				  <label for="pwd">Nome da Seção</label>
				  <input type="text" name="nomeSecao" required class="form-control" id="pwd">
				</div>
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           ...
                           <form method="POST" action="http://tcc2017.com.br/renato/tsis/secao/pesquisarSecao" > <input type="text" name="txtPesquisa" > <input type="submit" value="Pesquisar"> </form>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
