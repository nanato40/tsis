        ...
        if(window.confirm("Deseja realmente excluir?")){
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                        	...
                        	<form name="" method="POST" action="http://tcc2017.com.br/renato/tsis/estagiario/update/<?php echo $_SESSION["pessoa_id"];?>">
                        	
                        	<input type="hidden" value="<?php  echo $_SESSION["id_estagiario"]; ?>" name="txtId_estagiario" class="form-control" id="pwd">
                        	
				  <div class="form-group">
				  <label for="pwd">Nome do Estagiário</label>
				  <input type="text" value="<?php  echo $_SESSION["nome"]; ?>" name="txtNome" class="form-control" id="pwd">
				</div>
				...
				<div class="form-group">
				  ...
				  <input name="txtSemestre" value="<?php  echo $_SESSION["semestre"]; ?>" type="text" name="nomeSecao" class="form-control" id="pwd">
				</div>
				...
				<select name="txtSecao_id" class="form-control" id="sel1">
			...
			<div class="form-group">
				  ...
				  <input  type="text" value="<?php echo $_SESSION["contato"];?>" name="txtContato" class="form-control" id="pwd">
				</div>
 ...
 <?php  if(isset($_SESSION["dadosEstagiario"])){  ?>
   ...
   <?php } ?>
    ...
    ?>
      ...
      <td><a href="http://tcc2017.com.br/renato/tsis/secao/editar/<?php echo $value[3];?>"><button type="button" class="btn btn-outline-danger">Alterar</button></a>
