...
<div id="secoes" class="w3-container person">
 ...
 <div class="w3-container w3-blue">
  ...
  <form class="w3-container" name="" method="POST" action="http://tcc2017.com.br/renato/tsis/estagiario/update/<?php echo $_SESSION["pessoa_id"];?>">
  <p>
  <input name="txtId_estagiario" value="<?php echo $_SESSION["id_estagiario"];?>" type="hidden">
  <label>Editar Nome</label>
  <input class="w3-input" name="txtNome" value="<?php echo $_SESSION["nome"];?>" type="text"></p>
  <label>Editar Sexo</label>
  <select name="txtSexo" class="w3-select">
  ...
  <label>Editar Tipo de Ensino</label>
  <input class="w3-input" name="txtTipoEnsino" value="<?php echo $_SESSION["tipoEnsino"];?>" type="text"></p>
  <label>Editar Semestre</label>
  <input class="w3-input" name="txtSemestre" value="<?php echo $_SESSION["semestre"];?>" type="text"></p>
  <label>Editar Status</label>
  <input class="w3-input" name="txtStatus" value="<?php echo $_SESSION["status"];?>" type="text"></p>
  <label>Editar Seção</label>
  
  <p><select name="txtSecao_id" class="w3-select">
...
<p></p>
  ...
  <label>Editar Contato</label>
  <input class="w3-input" name="txtContato" value="<?php echo $_SESSION["contato"];?>" type="text"></p>
  
<input type="submit" value="Atualizar" class="w3-button w3-block w3-teal" />
