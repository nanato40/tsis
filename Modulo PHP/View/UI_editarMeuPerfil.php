...
<div id="secoes" class="w3-container person">
 ...
 <div class="w3-container w3-blue">
  ...
  <form class="w3-container" name="" method="POST" action="http://tcc2017.com.br/renato/tsis/usuario/update/<?php echo $_SESSION["id_usuario"];?>">
  
  <label>Email</label>
  <input class="w3-input" name="emailUsuario" value="<?php echo $_SESSION["emailEdit"];?>" type="text"></p>
  
  <label>Confirmar Email</label>
  <input class="w3-input" name="emailUsuario"  type="text"></p>
  
  <label>Senha</label>
  <input class="w3-input" name="senhaUsuario" value="<?php echo $_SESSION["senhaEdit"];?>" type="password"></p>
